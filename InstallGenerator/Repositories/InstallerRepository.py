class InstallerRepository:
    def __init__(self, file_repo, directory_repo, license_key_repo, language_repo, uninstaller_repo):
        self.id = None
        self.isShortcut = False
        self._directory_repo = directory_repo
        self._uninstaller_repo = uninstaller_repo
        self._file_repo = file_repo
        self._license_key_repo = license_key_repo
    ...
    def get_license_key_repo(self):
        return self._license_key_repo
